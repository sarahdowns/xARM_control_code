# File name: diag_sensor_ForceTorque.py
# This code initializes then measures the values of the force/torque sensor every half 
# second. It can be run at the same time as move code.
